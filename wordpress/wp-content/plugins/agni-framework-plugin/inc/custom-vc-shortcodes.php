...
class AgniShortcodesInitialization {
    function __construct() {
		...
		add_shortcode( 'agni_features', array( 'AgniShortcodesFunctions', 'agni_features' ) );
		...
		add_shortcode( 'agni_custom_slider', array( 'AgniShortcodesFunctions', 'agni_custom_slider' ) );
		add_shortcode( 'agni_posts', array( 'AgniShortcodesFunctions', 'agni_posts' ) );
