    ...
    public function integrateAgniWithVC() {
		...
		vc_add_param( "vc_row", array(
			...
			'value' => array(
				...
				esc_html__( 'Fullwidth content w/o padding', 'cookie' ) => 'has-fullwidth-column-no-padding',
			),
		...
		vc_map( array(
			...
			'params' => array(
				array(
					...
					'param_name' => 'date',
					'description' => esc_html__( 'you can type your deadline.', 'cookie' ),
					'std' => '20 January 2016 10:45:00'
				),
				array(
					'type' => 'textfield',
					'heading' => esc_html__( 'Label', 'cookie' ),
					'param_name' => 'label',
					'description' => esc_html__( 'you can type your label format.', 'cookie' ),
			...
			vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						'description' => esc_html__( 'Various Client display style.', 'cookie' ),
						'std' => '1'
					),
					array(
						'type' => 'dropdown',
    ...
    */
	...
	public static function agni_countdown( $atts = null, $content = null ) {
		$atts = shortcode_atts( array(
				...
				'label'	=> 'Day|Days|Hour|Hours|Minute|Minutes|Second|Seconds',
				'class' => ''
			), $atts, 'countdown' );		
