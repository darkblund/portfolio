...
if( $cookie_options['shop-sharing-panel'] == '1' ){
	function woocommerce_shop_sharing_panel(){ 
		global $cookie_options; ?>
        <div class=" shop-sharing-buttons">
            <ul class="list-inline">
                <?php  if($cookie_options['shop-sharing-icons'][1] == '1'){ ?>
                ...
                <?php  }?>
                <?php  if($cookie_options['shop-sharing-icons'][2] == '1'){ ?>
